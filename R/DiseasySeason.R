...
#' @export
DiseasySeason <- R6::R6Class(                                                                                           # nolint: object_name_linter, namespace_linter. We need to suppress namespace_linter until R-CMD-Check works with R6 fully
  ...
  public = list(
    ...
    set_reference_date = function(reference_date) {
      ...
      if (!is.null(private$.model_t)) {
        lgr::without_logging(                                                                                           # nolint: namespace_linter. We need to suppress until R-CMD-Check works with R6 fully
  ...
  private = list(
    ...
    scale_helper_glf = function(f, k, climate_normal, max_scale) {
      ...
      if (!private$is_cached(hash)) {
        ...
        a_values <- pracma::logseq(k, a_max)                                                                            # nolint: namespace_linter. We need to suppress until R-CMD-Check works with R6 fully
