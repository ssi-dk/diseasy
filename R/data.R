...
#' and 1 recovered compartment. The model uses an exposed period of 1 / rE = 2.1 days and a infectious period of
#' 1 / rI = 4.5 days.
...
#'   - `n_infected`: The direct output of the SEIR model (rI * I).
