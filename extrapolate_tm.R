...
tt <- tm <- c(0, cumsum(1 / delta_0)) + 1 / (2 * c(delta_0, tail(delta_0, 1)))
...
plot(tm_out, rep(1, M), col = "red", type = "p", xlim = c(0, max(t_out) + 1))
points(tm, rep(0.9, M - 1), col = "red", type = "p")
...
points(tm_out, rep(1.1, M), col = "red", type = "p")
...
points(tm_out, rep(1.2, M), col = "red", type = "p")
