...
obs$get_observation(
  ...
  stratification = rlang::quos(
    young_age_groups = age_group %in% c("00-09", "10-19")
  ),
  start_date = as.Date("2020-03-01"),
  end_date = as.Date("2020-05-01")
)

# NOTE: "target_conn" is a SQLite data base which has "numeric"
# as the "boolean" type.
```
