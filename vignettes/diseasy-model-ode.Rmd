...
```{r example data infected, eval = rlang::is_installed("ggplot2"), fig.alt = "Data to model: True number of infected."}
...
```{r example data positive, eval = rlang::is_installed("ggplot2"), fig.alt = "Data to model: Number of positive cases."}
observables$get_observation(
...
```{r example data admission, eval = rlang::is_installed("ggplot2"), fig.alt = "Data to model: Number of hospital admissions."}
observables$get_observation(
...
```{r, fig.alt = "Model prediction for the number of ncidence - stratified by age group."}
plot(
  model,
  observable = "incidence",
...
```{r, fig.alt = "Model prediction for the number of infected - stratified by age group."}
plot(
  model,
  observable = "n_infected",
  prediction_length = 60
...
```{r, fig.alt = "Model prediction for the number of positive."}
plot(
  model,
  observable = "n_positive",
  prediction_length = 60
...
```{r, fig.alt = "Model prediction for the number of positive - stratified by age group."}
plot(
  model,
  observable = "n_positive",
  prediction_length = 60,
...
```{r, fig.alt = "Model prediction for the number of hospital admissions."}
plot(
  model,
  observable = "n_admission",
  prediction_length = 60
...
```{r, fig.alt = "Model prediction for the number of hospital admissions - stratified by age group."}
plot(
  model,
  observable = "n_admission",
  prediction_length = 60,
