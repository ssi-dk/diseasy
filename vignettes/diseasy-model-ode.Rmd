...
# We will destroy the cache if the source code for `DiseasyModelOde`, or `DiseasyModelOdeSeir` changes
...
source_code_hash <- c(DiseasyBaseModule, DiseasyModel, DiseasyModelOde, DiseasyModelOdeSeir) |>
  purrr::map(r6_hash) |>
  rlang::hash()
