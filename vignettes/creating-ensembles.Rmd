...
```{r, fig.alt = "Plot of the ensemble predictions. Shaded area is ensemble quantiles with observations as points."}
...
```{r, fig.alt = "Plot of the ensemble predictions stratified by age group. Shaded area is ensemble quantiles with observations as points."}
plot(
  ensemble,
...
```{r, fig.alt = "Plot of the ensemble predictions stratified by custom age group. Shaded area is ensemble quantiles with observations as points."}
plot(
  ensemble,
  observable = "n_positive",
...
```{r, fig.alt = "Plot of the ensemble predictions my model. Shaded area is ensemble quantiles with observations as points."}
plot(
  ensemble,
  observable = "n_positive",
  prediction_length = 30,
...
```{r, fig.alt = "Plot of predictions from alternative ensemble. Shaded area is ensemble quantiles with observations as points."}
plot(ensemble, observable = "n_positive", prediction_length = 30)
```
