...
```{r elbow curve method, eval = !missing_suggests, fig.alt = "Increasing number of compartments has diminishing returns on the error.", eval = rlang::is_installed(c("ggplot2", "tibble"))}
# Prepare the data
...
```{r check_cache, include = FALSE, eval = rlang::is_installed(c("ggplot2", "tibble")) &&  = !missing_suggests}
