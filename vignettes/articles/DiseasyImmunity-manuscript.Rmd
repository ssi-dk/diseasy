...
im$approximate_compartmental(method = "free_delta", N = 2)
```
...
cache <- cachem::cache_disk(dir = devtools::package_file("vignettes/articles/article_data/optim"))

# Set the optimiser configurations to test
optim_configs <- list(
  list("method" = "Nelder-Mead", "maxit" = 10, "maxfeval" = 200),
  list("method" = "BFGS", "maxit" = 10, "maxfeval" = 200),
  list("method" = "CG", "maxit" = 10, "maxfeval" = 200),
  list("method" = "subplex", "maxit" = 10, "maxfeval" = 200),
  list("method" = "nlm", "maxit" = 10, "maxfeval" = 200),
  list("method" = "nlminb", "maxit" = 10, "maxfeval" = 200),
  #list("method" = "Rcgmin", "maxit" = 10, "maxfeval" = 200), # Method issue, NA params?
  #list("method" = "Rtnmin", "maxit" = 10, "maxfeval" = 200), # Method issue, NA params?
  #list("method" = "Rvmmin", "maxit" = 10, "maxfeval" = 200), # Method issue, NA params?
  #list("method" = "snewton", "maxit" = 10, "maxfeval" = 200), # Needs gradient and Hessian
  #list("method" = "snewtonm", "maxit" = 10, "maxfeval" = 200), # Needs gradient and Hessian
  list("method" = "spg", "maxit" = 10, "maxfeval" = 200),
  list("method" = "hjn", "maxit" = 10, "maxfeval" = 200),
  list("method" = "nvm", "maxit" = 10, "maxfeval" = 200),
  list("method" = "slsqp", "maxit" = 10, "maxfeval" = 200),
  list("method" = "tnewt", "maxit" = 10, "maxfeval" = 200),
  list("method" = "anms", "maxit" = 10, "maxfeval" = 200),
  list("method" = "pracmanm", "maxit" = 10, "maxfeval" = 200),
  list("method" = "nlnm", "maxit" = 10, "maxfeval" = 200)#,
  #list("method" = "snewtm", "maxit" = 10, "maxfeval" = 200), # Needs gradient and Hessian
)
...
progressr::with_progress({
  ...
  invisible(future.apply::future_lapply(
    ...
    FUN = \(combination) {
      ...
      current_approxes <- cache$get(key = glue::glue("{model_name}-{method}-{monotonic}-{individual_level}-{N}"))

      mc <- tibble::tibble(
        "method" = optim_config$method,
        "maxit" = optim_config$maxit,
        "maxfeval" = optim_config$maxfeval
      ) |>
      ...
      if (!(optim_label %in% names(current_approxes))) {
        ...
        approx <- im_p$approximate_compartmental(
          ...
          monotonic = monotonic,
          individual_level = individual_level,
          optim.method = optim_config$method,
          maxit = optim_config$maxit,
          maxfeval = optim_config$maxfeval
        )
        ...
        # Store to cache
        cache$set(key = glue::glue("{model_name}-{method}-{monotonic}-{individual_level}-{N}"), current_approxes)
      }
...
```{r compare optimisations}
optim_summery <- combinations_single |>
...
```{r compare optimisations single metic}
tt <- optim_summery |>
  dplyr::summarise(
...
optim_summery |>
  ...
  ggplot2::ggplot(ggplot2::aes(x = value, y = as.numeric(execution_time), color = convergence)) +
  ggplot2::geom_point() +
  ggplot2::geom_text(ggplot2::aes(label = optim_method), nudge_x = 0, nudge_y = -2) +
  ggplot2::labs(x = "Value", y = "Execution time") +
  ggplot2::theme_bw() +
  ggplot2::xlim(0, NA) +
  ggplot2::ylim(0, NA) +
...
# Set the optimiser configurations to test
optim_configs <- list(
  list("method" = "nlm", "maxit" = 10, "maxfeval" = 25),
  list("method" = "nlm", "maxit" = 10, "maxfeval" = 50),
  list("method" = "nlm", "maxit" = 10, "maxfeval" = 100),
  list("method" = "nlm", "maxit" = 5, "maxfeval" = 200),
  list("method" = "nlm", "maxit" = 10, "maxfeval" = 200),
  list("method" = "nlnm", "maxit" = 10, "maxfeval" = 100),
  list("method" = "nlnm", "maxit" = 5, "maxfeval" = 200),
  list("method" = "nlnm", "maxit" = 10, "maxfeval" = 200),
  list("method" = "nlnm", "maxit" = 20, "maxfeval" = 200),
  list("method" = "nlminb", "maxit" = 10, "maxfeval" = 100),
  list("method" = "nlminb", "maxit" = 5, "maxfeval" = 200),
  list("method" = "nlminb", "maxit" = 10, "maxfeval" = 200)
)
...
# Set the optimiser configurations to test
optim_configs <- list(
  list("method" = c("nlm", "BFGS"), "maxit" = c(5, 10), "maxfeval" = 100),
  list("method" = c("nlm", "Nelder-Mead"), "maxit" = c(5, 10), "maxfeval" = c(100, 200)),
  list("method" = c("nlm", "nlnm"), "maxit" = c(5, 10), "maxfeval" = 100),
  list("method" = "nlnm", "maxit" = 10, "maxfeval" = 100) # Use as reference - also converges
)
...
progressr::with_progress({
  ...
  invisible(future.apply::future_lapply(
    ...
    FUN = \(combination) {
      ...
      # Get the results up until now
      current_approxes <- cache$get(key = glue::glue("{model_name}-{method}-{monotonic}-{individual_level}"))

      # Compute next values
      if (!(N %in% names(current_approxes))) {

        approx <- im_p$approximate_compartmental(method = method, N = N, monotonic = monotonic, individual_level = individual_level, optim.method = c(rep("subplex", 2), "CG"), maxit = c(rep(100, 2), 100), maxfeval = c(rep(250, 2), 1000))
        ...
        # Store to cache
        cache$set(key = glue::glue("{model_name}-{method}-{monotonic}-{individual_level}"), current_approxes)
      }
...
#ggplot2::ggsave(glue::glue("monotoniggplot2::ggsave("subplex_10")c_{monotonic}_individual_level_{individual_level}.png"))
...
progressr::with_progress({
  ...
  invisible(future.apply::future_lapply(
    ...
    FUN = \(combination) {
      ...
      # Get the results up until now
      current_approxes <- cache$get(key = glue::glue("{model1_name}-{model2_name}-{method}-{monotonic}-{individual_level}"))
      ...
      if (!(N %in% names(current_approxes))) {
        ...
        approx <- im_p$approximate_compartmental(method = method, N = N, montonic = monotonic, individual_level = individual_level)
        ...
        # Store to cache
        cache$set(key = glue::glue("{model1_name}-{model2_name}-{method}-{monotonic}-{individual_level}"), current_approxes)
      }
