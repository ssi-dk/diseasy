...
optim_configs <- list(
  ...
  data.frame("method" = "anms", "maxfeval" = 200),
...
optim_configs <- list(
  ...
  data.frame("method" = "nlm", "maxit" = 20, "maxfeval" = 100),
  data.frame("method" = "nlm", "maxit" = 40, "maxfeval" = 100),
  ...
  data.frame("method" = "nlnm", "maxit" = 30, "maxfeval" = 300),
  data.frame("method" = "nlnm", "maxit" = 40, "maxfeval" = 400),
