...
im$approximate_compartmental(method = "free_delta", N = 3, monotonous = F, individual_level = F)
```
```{r}
im$approximate_compartmental(method = "free_gamma", N = 3, monotonous = F, individual_level = F)
```

```{r}
im$approximate_compartmental(method = "all_free", N = 3, monotonous = F, individual_level = F)
```

```{r}
im$approximate_compartmental(method = "all_free_combi", N = 3, monotonous = F, individual_level = F)
```
...
```{r summariser helper}
summariser <- function(combinations, monotonous, individual_level, cache) {
...
summariser(combinations, monotonous = monotonous, individual_level = individual_level, cache = cache)
```
...
optim_configs <- list(
  ...
  data.frame("method" = c("nlm", "BFGS"), "maxit" = c(20, 25)),
  data.frame("method" = c("nlm", "BFGS"), "maxit" = c(5, 50)),
  data.frame("method" = c("nlm", "BFGS"), "maxit" = c(10, 50)),
  data.frame("method" = c("nlm", "BFGS"), "maxit" = c(20, 50)),
...
summariser(combinations, monotonous = 100, individual_level = 0, cache = cache)
```
