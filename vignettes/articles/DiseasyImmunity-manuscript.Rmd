...
optim_configs <- list(
  data.frame("method" = "Nelder-Mead", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "BFGS", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "CG", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "subplex", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "nlm", "maxit" = 10, "maxfeval" = 200),
  ...
  data.frame("method" = "hjn", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "nvm", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "slsqp", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "tnewt", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "anms", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "pracmanm", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "nlnm", "maxit" = 10, "maxfeval" = 200)#,
    ...
    FUN = \(combination) {
      ...
      if (!(optim_label %in% names(current_approxes))) {
        ...
        approx <- im_p$approximate_compartmental(
          ...
          monotonic = monotonic,
          individual_level = individual_level,
          polyopt_methodcontrol = optim_config
        )
...
# Set the optimiser configurations to test
optim_configs <- list(
  data.frame("method" = "nlm", "maxit" = 10, "maxfeval" = 25),
  data.frame("method" = "nlm", "maxit" = 10, "maxfeval" = 50),
  data.frame("method" = "nlm", "maxit" = 10, "maxfeval" = 100),
  data.frame("method" = "nlm", "maxit" = 5, "maxfeval" = 200),
  data.frame("method" = "nlm", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "nlnm", "maxit" = 10, "maxfeval" = 100),
  data.frame("method" = "nlnm", "maxit" = 5, "maxfeval" = 200),
  data.frame("method" = "nlnm", "maxit" = 10, "maxfeval" = 200),
  data.frame("method" = "nlnm", "maxit" = 20, "maxfeval" = 200),
...
# Set the optimiser configurations to test
optim_configs <- list(
  data.frame("method" = c("nlm", "BFGS"), "maxit" = c(5, 10), "maxfeval" = 100),
  data.frame("method" = c("nlm", "Nelder-Mead"), "maxit" = c(5, 10), "maxfeval" = c(100, 200)),
  data.frame("method" = c("nlm", "nlnm"), "maxit" = c(5, 10), "maxfeval" = 100),
  data.frame("method" = "nlnm", "maxit" = 10, "maxfeval" = 100) # Use as reference - also converges
)
