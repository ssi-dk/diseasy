...
from the state-vector, $\overline{\psi}$.
...
For each of such vectors, a "surveillance" state is added to the state-vector which
...
In the former case, the surveillance states derived from the state-vector where as
