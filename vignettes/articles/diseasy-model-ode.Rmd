...
```{r configuration test - incidence, include = FALSE, eval = F && rlang::is_installed(c("RSQLite", "optimx", "ucminf"))}
...
```{r configuration test - n_infected, include = FALSE, eval = F && rlang::is_installed(c("RSQLite", "optimx", "ucminf"))}
# This code block is used as a sanity check that the models work as expected
# When the model works, we should be able to closely match model with data
# - when not, we get informed by an error
observable <- "n_infected"
...
```{r configuration test - n_positive, include = FALSE, eval = F && rlang::is_installed(c("RSQLite", "optimx", "ucminf"))}
# This code block is used as a sanity check that the models work as expected
# When the model works, we should be able to closely match model with data
# - when not, we get informed by an error
observable <- "n_positive"
...
```{r configuration test - n_admission, include = FALSE, eval = F && rlang::is_installed(c("RSQLite", "optimx", "ucminf"))}
# This code block is used as a sanity check that the models work as expected
# When the model works, we should be able to closely match model with data
# - when not, we get informed by an error
observable <- "n_admission"
