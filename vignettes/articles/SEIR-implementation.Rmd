...
Then expanding by $N / N$ and expressing in terms of $c_{p,q} = \frac{t_{ij}}{\tilde{N}_p\tilde{N}_q}$.
$$
...
- The state specific infection risks (p.e. the reduced risk from being infected previously / vaccinated)
