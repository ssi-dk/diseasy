...
knitr::include_graphics(
  devtools::package_file("vignettes/articles/article_data/SEIR-implementation-model.png")
)
```
...
knitr::include_graphics(
  devtools::package_file("vignettes/articles/article_data/SEIR-implementation-index.png")
)
```
