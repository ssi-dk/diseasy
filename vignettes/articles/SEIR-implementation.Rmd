...
We are therefore interested in the reduced state vector $\overline{\psi}_{RS}$ whose elements $e^*$ are the $R$
...
\overline{\overline{U}}
$$
Where $\begin{bmatrix}\overline{\psi}_{RS} & \cdots & \overline{\psi}_{RS}\end{bmatrix}$ is $V$ repeats of the
