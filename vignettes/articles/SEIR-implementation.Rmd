...
$$
\tilde{N}c_{i,j} = \frac{\tilde{N}}{N_i} \frac{t_{i,j}}{N_i} = \frac{\tilde{N}}{N_i} m_{i,j}
$$

where $m_{i,j}$ is the output of `$get_scenario_contacts()` and the rescaling $\frac{\tilde{N}}{N_i}$ can be performed
