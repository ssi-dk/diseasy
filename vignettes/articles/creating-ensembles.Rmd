...
contact_basis_1 <- contact_basis_2 <- contact_basis_3 <- contact_basis_nordic$DK
contact_basis_2$contacts <- contact_basis_nordic$SE$contact
contact_basis_3$contacts <- contact_basis_nordic$NO$contact
