...
For example, hospitalisation might occur an average of 7 days after infection.
...
1) To determine $I_1$ for `time < 0` we can simply use the input signal given the
...
x <- m$get_results(observable = "incidence", prediction_length = 50)
y <- m$get_data(
  observable = "incidence", prediction_length = 50, period = "plotting"
) |>
