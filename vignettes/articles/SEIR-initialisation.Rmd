...
There is an interesting consequence here. If the equations are modified as above, we can also infer what the 
corresponding value of $\beta$ should be. Since we claim to know $I$ and $S$, we can solve for what $\beta$ should be.
