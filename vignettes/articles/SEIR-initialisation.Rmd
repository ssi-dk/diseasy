...
\end{bmatrix}
$$
Which can be solved with two additional constants:
$I^\dag = I_1 + I_2$ and $E_1 + E_2 + I_1 + I_2 = 1 - \beta S I^\dag$.
...
The $SR$ states of the SEIR model should capture both the short and the long term developments of the signal
we want to match.
