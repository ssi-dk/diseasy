...
| Sum of exponentials | $0.5 \cdot \left(\exp(-0.5 t / \tau) + \exp(-2 t / \tau)\right)$          |
...
The entire optimisation process is run without penalty (`monotonous = 0` and `individual_level = 0`),
and with only a monotonicity penalty (`monotonous = 1` and `individual_level = 0`),
and with both penalties (`monotonous = 1` and `individual_level = 1`).
...
bold_min_value <- function(gt_table) {
  ...
  gt_table |>
    ...
    gt::tab_style(
      ...
      locations = gt::cells_body(
        columns = dplyr::ends_with(min_value$name[[3]]),
        rows =  min_value$row_id[[3]]
      )
    )
}
...
total_results |>
  ...
  dplyr::mutate("penalty" = dplyr::if_else(.data$penalty == "Monotonous", "Mon.", .data$penalty)) |>
...
chosen_defaults <- tibble::tibble(
  ...
  tibble::add_row(
    "method" = "free_delta", "penalty" = "None",
    "strategy" = "recursive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "free_delta", "penalty" = "Monotonous",
    "strategy" = "recursive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "free_delta", "penalty" = "Both",
    "strategy" = "recursive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "free_gamma", "penalty" = "None",
    "strategy" = "naive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "free_gamma", "penalty" = "Monotonous",
    "strategy" = "naive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "free_gamma", "penalty" = "Both",
    "strategy" = "naive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "all_free", "penalty" = "None",
    "strategy" = "naive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "all_free", "penalty" = "Monotonous",
    "strategy" = "naive",
    "optim_method" = "ucminf"
  ) |>
  tibble::add_row(
    "method" = "all_free", "penalty" = "Both",
    "strategy" = "naive",
    "optim_method" = "ucminf"
  )
```
