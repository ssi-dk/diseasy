test_that("initialize works", {
  ...
  m1 <- DiseasyModelRegression$new(formula = "{observable} ~ 0",
                                   family = stats::poisson(),
                                   training_length = 21)


  m2 <- DiseasyModelRegression$new(formula = "{observable} ~ 1",
                                   family = stats::poisson(),
                                   training_length = 21)
  expect_false(m2$hash == m1$hash)

  m3 <- DiseasyModelRegression$new(formula = "{observable} ~ 0",
  ...
  m4 <- DiseasyModelRegression$new(formula = "{observable} ~ 0",
                                   family = stats::poisson(),
                                   training_length = 14)
  ...
  m5 <- DiseasyModelRegression$new(formula = "{observable} ~ 1",
                                   family = stats::quasipoisson(),
                                   training_length = 21)
  ...
  m6 <- DiseasyModelRegression$new(formula = "{observable} ~ 0",
                                   family = stats::quasipoisson(),
                                   training_length = 14)
  ...
  m7 <- DiseasyModelRegression$new(formula = "{observable} ~ 1",
                                   family = stats::quasipoisson(),
                                   training_length = 14)
